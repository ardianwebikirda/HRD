Ext.define('HRIS.controller.dashboard',{
	extend	: 'Ext.app.Controller',
    init: function() {
        var me = this;
        me.getStore('HRIS.store.TreeStore');
        me.control({
    ...
    rubahPswd : function(button){
        var win = Ext.create('HRIS.module.GeneralSetup.view.form.EditPswd');
        win.show();
    }, 
    rubah : function(btn){
        var me          = this;
