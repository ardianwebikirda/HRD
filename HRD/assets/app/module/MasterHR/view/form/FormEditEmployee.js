Ext.define('HRIS.module.MasterHR.view.form.FormEditEmployee',{
    extend      : 'Ext.window.Window',
    closeable   : true,
    modal       : true,
    alias       : 'widget.formeditemployee',
    id          : 'formeditemployee',
    title       : 'Form Update Employee',
    ...
    bbar        : [
        '->',
        {xtype: 'button', text: 'Update', iconCls: 'icon-pencil', action: 'update'}       
    ],
                    ...
                    items       : [
                        {
                            ...
                            allowBlank      : false,
                            msgTarget       : 'under',
                            store           : 'HRIS.module.MasterData.store.MinCountry',
                            displayField    : 'name',
                            valueField      : 'id',
                            editable        : true,
                    ...
                    items       : [
                        {
                            ...
                            emptyText       : 'City / Region',
                            tooltip         : 'City / Region',
                            name            : 'id_region',
                            id              : 'id_region',
                            xtype           : 'combobox',
                            store           : Ext.create('HRIS.module.MasterData.store.UpdateRegion'),
                            displayField    : 'name',
                            valueField      : 'id',
                            editable        : true,
                            typeAhead       : true,
